          ...
          {userclicked && (
            ...
            >
              <ul className="flex flex-col">
                <li className="cursor-pointer hover:bg-[#7d7d7d] p-2 rounded-t-lg flex justify-start items-center gap-x-3"> <p className="text-[25px]"><CiUser/></p><p>Manage My Account</p></li>
                <li className="cursor-pointer hover:bg-[#7d7d7d] p-2 flex justify-start items-center gap-x-3"><p className="text-[25px]"><FiShoppingBag /></p><p>My Order</p></li>
                <li className="cursor-pointer hover:bg-[#7d7d7d] p-2 flex items-center gap-x-3"><p className="text-[25px]"><MdOutlineCancel /></p> My Cancellations</li>
                <li className="cursor-pointer hover:bg-[#7d7d7d] p-2 flex justify-start items-center gap-x-3"><p className="text-[25px]"><FaRegStar /> </p> My reviews</li>
                <li className="cursor-pointer hover:bg-[#7d7d7d] p-2 rounded-b-lg flex justify-start items-center gap-x-3"><p className="text-[25px]"><CiLogout /> </p>Logout</li>
              </ul>
            </div>
          )}
        </div>
