...
const Itemcard = () => {
  return (
      ...
      <div className="h-[350px] w-[270px] md:flex flex-col relative group items-center justify-center">
        <div className=" bg-[#F5F5F5] h-[250px] ">
          ...
          <button className="bg-black text-white absolute bottom-[100px] left-0 h-12 w-full opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out flex items-center justify-center">Add to cart</button>
        </div>
